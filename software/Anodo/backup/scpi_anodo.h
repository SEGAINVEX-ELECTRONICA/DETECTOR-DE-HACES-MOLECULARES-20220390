...
MENU_SCPI // menú de  comandos y submenús OBLIGATORIO
    {
        ...
        SCPI_COMANDO(INTERRUPCION, INT, interrupcion)  // experimental
...
void help()
{
    scpiPrintln("PNT <valor>\n actualiza en flash variable m de una\n recta de calibracion mx+b");
    scpiPrintln("OFF <valor>\n actualiza en flash variable b de una\n recta de calibracion mx+b");
...
void interrupcion(void)
{
    ...
    if (estado)
    {
        ...
        scpiPrintln("int. SERCOM2 inhabilitado");
    }
    else
    {
        NVIC_EnableIRQ(SERCOM2_IRQn);
        scpiPrintln("int. SERCOM2 habilitada");
    }
    estado = !estado;
}
/************************************************************************
