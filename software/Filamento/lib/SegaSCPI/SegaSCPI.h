 ...
 *************************************************************************/
//Hay que dejar sin comentar el tipo o la clase del serial que utilice el micro.
//#define TIPO_SERIAL USBSerial
#define TIPO_SERIAL HardwareSerial
//#define TIPO_SERIAL USBCDC
...
public:
    //Variables y objetos públicas
      ...
      TIPO_SERIAL *PuertoActual;//Puerto Serie
    //Métodos públicos
      SegaSCPI(tipoNivel *pRaiz ,const char*,String*); //Constructor
      void scpi(/*USARTClass**/ TIPO_SERIAL* );//Función de entrada a SegaSCPI
